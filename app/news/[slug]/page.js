...
export default function NewsDetailPage({ params }) {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">News Detail Page</h1>
      <article className="bg-white rounded-lg shadow-md p-6 md:p-12 lg:p-16 max-w-3xl mx-auto">
        <header className="mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">{newsItem.title}</h2>
